...
const en: Resources = {
  ...
  home: {
    newChat: "New chat",
    hero: "Turn speeches into reusable knowledge assets",
    placeholder:
    ...
    referenceTooltip: "Upload a transcript, slides, or reference material",
    ...
    storage: "0 GB / 100 GB",
    noProjects: "No projects yet — start by describing what you want above.",
    tools: {
