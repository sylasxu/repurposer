...
- **Intent channel**: homepage prompt = `GenerateRequest.instruction`, passed to analyzer/script and linkedin/quote_card/carousel/summary/blog, used to select clips, determine hook/title, and bias output focus.
